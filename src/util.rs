    ...
    for _i in 0..num {
        ...
        for j in 1..digits.len() {
            ...
            if digits[index] > digits[index - 1] {
                ...
                right_chunk.sort();
                let result = right_chunk
                    .binary_search(&current_val)
                    .expect("wierd error");
...
// return true if a|b and b|a are both prime
pub fn concat_is_prime(a: usize, b: usize, prime_sieve: &primal::Sieve) -> bool {
    // check if a|b is a prime
