...
//    println!( "{}", line );
    ...
    let player1: Hand = Hand{ cards : [ cards.remove(0), cards.remove(0), cards.remove(0), cards.remove(0), cards.remove(0) ] };
    let player2: Hand = Hand{ cards : [ cards.remove(0), cards.remove(0), cards.remove(0), cards.remove(0), cards.remove(0) ] };
